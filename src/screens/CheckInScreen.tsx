...
export function CheckInScreen() {
  ...
  return (
    <div className="flex flex-col h-full bg-[var(--color-paper)] relative">
      <header className="px-4 pt-10 pb-6 flex items-center gap-6 border-b border-[var(--color-forest)]/10 bg-[var(--color-paper)]/80 backdrop-blur-md z-10 sticky top-0">
        <BackButton to="/home" />
      ...
      <div className="flex-1 overflow-y-auto p-4 pb-32">
        <div className="mb-8">
          <h2 className="text-[22px] font-serif text-[var(--color-forest)] mb-2">
            How is your mind right now?
          </h2>
          <p className="text-[14px] text-[var(--color-forest)]/60 font-sans">
            Slide to indicate your current mental capacity (there's no right
            answer)
          </p>
        </div>
        ...
        <div className="space-y-8">
          ...
          <div className="bg-[var(--color-art-comp)]/10 p-4 rounded-[8px] flex gap-3 items-start border border-[var(--color-art-comp)]/20">
            ...
            <p className="text-[12px] text-[var(--color-forest)]/80 leading-relaxed font-sans">
              you're offline - check-in saved locally. matches will sync when
              connection returns.
            </p>
          </div>
        </div>
